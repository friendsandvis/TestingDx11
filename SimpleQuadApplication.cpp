...
{
	//create shaders
	m_simplePixelShader.Init(device, L"shaders/simplequad/PS.hlsl", ShaderType::PS, "main");
	m_simpleVertexShader.Init(device, L"shaders/simplequad/VS.hlsl", ShaderType::VS, "main");
